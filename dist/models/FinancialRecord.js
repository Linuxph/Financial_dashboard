...
const financialRecordSchema = new mongoose_1.Schema({
    amount: { type: Number, required: true, min: finance_1.financeConfig.minAmount },
    type: { type: String, enum: ['income', 'expense'], required: true },
    category: { type: String, required: true, enum: finance_1.financeConfig.categories, trim: true },
